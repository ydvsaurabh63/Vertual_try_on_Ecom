...
const HomePage = () => {
  ...
  return (
    <div className="space-y-20">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative rounded-3xl bg-[#121216] border border-white/10 overflow-hidden p-8 sm:p-12 flex flex-col lg:flex-row items-center justify-between gap-8">
          
          {/* Left Text */}
          <div className="max-w-xl space-y-4 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#c87d4a]/20 border border-[#c87d4a]/40 text-[#c87d4a] text-xs font-bold uppercase tracking-wider">
            ...
            <div className="pt-2">
              <button
                ...
                className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-[#c87d4a] hover:bg-[#d28a57] text-white font-semibold text-xs tracking-wider uppercase shadow-xl shadow-[#c87d4a]/25 transition-all transform hover:-translate-y-0.5"
              >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="relative h-[480px] rounded-3xl overflow-hidden border border-white/10 group flex items-end p-8">
            <img
            ...
            <div className="relative z-10 space-y-3">
              ...
              <h3 className="text-3xl font-serif font-bold text-white">Autumn Minimalist Elegance</h3>
          ...
          <div className="relative h-[480px] rounded-3xl overflow-hidden border border-white/10 group flex items-end p-8">
            ...
            <div className="relative z-10 space-y-3">
              ...
              <h3 className="text-3xl font-serif font-bold text-white">Modern Gentleman Suits</h3>
